...
/*   Updated: 2020/02/29 21:23:31 by mleticia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (all_mod->f_0 == 'N' && all_mod->f_min == '-' && (all_mod->prc == -1 \
	|| all_mod->prc < len))
		all_mod->res += ft_wx(all_mod->width - len, ' ');
	...
	else if (all_mod->f_0 == 'N' && (all_mod->prc == -1 || all_mod->prc < len))
		all_mod->res += ft_wx(all_mod->width - len, '0');
	else if ((all_mod->f_sp == 'S' && all_mod->width > len && all_mod->f_min != '-') || (all_mod->f_min == '-' && (*sign == '-') && all_mod->prc == -1))
		all_mod->res += ft_wx(all_mod->width - len, ' ');
	else if (all_mod->f_sp == 'S')
		all_mod->res += ft_wx(all_mod->width - len - 1, ' ');
	else if ((all_mod->prc == -1) || (all_mod->prc < len))
		all_mod->res += ft_wx(all_mod->width - len, ' ');
